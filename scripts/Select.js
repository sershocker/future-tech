...
import MatchMedia from "./MathMedia.js";
...
class Select extends BaseComponent {
  ...
  fixDropdownPosition() {
    ...
    const isButtonOnTheLseftViewportSide = buttonCenterX < halfViewportX;

    this.dropdownElement.classList.toggle(this.stateClasses.isOnTheLeftSide, isButtonOnTheLseftViewportSide);

    this.dropdownElement.classList.toggle(this.stateClasses.isOnTheRightSide, !isButtonOnTheLseftViewportSide);
  }
